    ...
    <section id="despre-noi-detalii" className="relative bg-white overflow-hidden" ref={ref}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[680px]">
        ...
        <div className={`relative h-[420px] lg:h-auto overflow-hidden transition-all duration-1000 ${visible ? 'opacity-100' : 'opacity-0'}`}>
          <img
            src="https://readdy.ai/api/search-image?query=happy%20children%20learning%20together%20in%20a%20warm%20bright%20modern%20private%20school%20building%20Romania%20interior%20wide%20hallway%20with%20natural%20light%20educational%20artwork%20on%20walls%20students%20walking%20engaged%20lively%20school%20day%20atmosphere%20professional%20photography%20cinematic%20wide%20angle&width=900&height=1000&seq=why-cine-1&orientation=portrait"
