  ...
  return (
    <section id="acasa" className="relative w-full min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        <img
          src="https://readdy.ai/api/search-image?query=warm%20bright%20modern%20private%20school%20classroom%20Romania%20children%20learning%20dedicated%20teacher%20small%20class%20group%20educational%20institution%20authentic%20academic%20structured%20setting%20natural%20daylight%20streaming%20large%20windows%20professional%20photography%20cinematic%20depth%20warm%20amber%20blue%20tones&width=1920&height=1080&seq=hero-cine-2&orientation=landscape"
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-0 items-center">
          ...
          <div className="max-w-[680px]">
            ...
            <div className="xl:hidden mt-12 grid grid-cols-2 gap-3">
              <div className="relative h-32 rounded-2xl overflow-hidden" style={{ boxShadow: '0 8px 24px rgba(0,0,0,0.55)' }}>
                ...
                <img
                  src="https://readdy.ai/api/search-image?query=children%20playing%20outdoor%20playground%20private%20school%20Romania%20sunny%20day%20safe%20colorful%20equipment%20modern%20clean%20fenced%20yard%20professional%20photography&width=400&height=280&seq=hero-r2m&orientation=landscape"
                  alt="Teren de joacă"
              ...
              <div className="relative h-32 rounded-2xl overflow-hidden" style={{ boxShadow: '0 8px 24px rgba(0,0,0,0.55)' }}>
                <div className="absolute inset-0 bg-gradient-to-t from-navy-950/75 to-transparent z-10" />
                <img
                  src="https://readdy.ai/api/search-image?query=school%20children%20music%20dance%20creative%20activity%20cheerful%20colorful%20classroom%20warm%20tones%20Romania%20candid%20educational%20program%20professional%20photography&width=400&height=280&seq=hero-r3m&orientation=landscape"
          ...
          <div className="hidden xl:flex flex-col items-end gap-4 pl-12 animate-fade-in delay-600">
            ...
            <div className="relative w-[390px] h-[285px] rounded-2xl overflow-hidden animate-float-slow" style={{ boxShadow: '0 40px 72px rgba(0,0,0,0.55), 0 0 0 1px rgba(255,255,255,0.06)' }}>
              ...
              <img
                src="https://readdy.ai/api/search-image?query=teacher%20with%20small%20group%20children%20in%20bright%20private%20school%20classroom%20Romania%20engaged%20learning%20collaborative%20desks%20natural%20light%20warm%20academic%20atmosphere%20close%20up%20candid%20professional%20photography&width=740&height=540&seq=hero-r1&orientation=landscape"
            ...
            <div className="flex gap-3.5 w-[390px]">
              <div className="relative flex-1 h-[155px] rounded-xl overflow-hidden animate-float-slow" style={{ animationDelay: '1.5s', boxShadow: '0 20px 44px rgba(0,0,0,0.45)' }}>
                ...
                <img
                  src="https://readdy.ai/api/search-image?query=children%20playing%20outdoor%20playground%20private%20school%20Romania%20sunny%20day%20safe%20colorful%20equipment%20modern%20fenced%20yard%20professional%20photography%20bright%20cheerful&width=380&height=280&seq=hero-r2&orientation=landscape"
                  alt="Teren de joacă"
                  className="w-full h-full object-cover object-top"
                />
              ...
              <div className="relative flex-1 h-[155px] rounded-xl overflow-hidden animate-float-slow" style={{ animationDelay: '3.0s', boxShadow: '0 20px 44px rgba(0,0,0,0.45)' }}>
                <div className="absolute inset-0 bg-gradient-to-t from-navy-950/70 to-transparent z-10" />
                <img
                  src="https://readdy.ai/api/search-image?query=school%20children%20singing%20dancing%20musical%20activity%20cheerful%20colorful%20classroom%20warm%20tones%20Romania%20candid%20educational%20professional%20photography%20engaged%20happy%20kids&width=380&height=280&seq=hero-r3&orientation=landscape"
                  alt="Activități variate"
                  className="w-full h-full object-cover object-top"
                />
