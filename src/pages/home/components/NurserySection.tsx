      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-3 gap-4 transition-all duration-700 delay-500 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <div className="lg:col-span-2 h-64 rounded-2xl overflow-hidden relative img-zoom-wrap shadow-[0_8px_40px_rgba(9,24,56,0.1)]">
            <img
              src="https://readdy.ai/api/search-image?query=warm%20cozy%20Romanian%20kindergarten%20classroom%20children%20playing%20with%20colorful%20toys%20on%20soft%20rugs%20natural%20light%20coming%20through%20large%20windows%20caring%20teacher%20kneeling%20beside%20toddler%20warm%20amber%20tones%20safe%20nurturing%20environment%20wooden%20furniture%20plants%20bookshelves&width=860&height=420&seq=nursery2&orientation=landscape"
