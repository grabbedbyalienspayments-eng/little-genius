      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6 transition-all duration-700 delay-100 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
          ...
          <div className="lg:col-span-3 rounded-2xl overflow-hidden h-[400px] facility-img-wrap relative">
            <img
              src="https://readdy.ai/api/search-image?query=modern%20private%20school%20classroom%20interior%20Romania%20with%20large%20smartboard%20at%20the%20front%20displaying%20educational%20content%20bright%20natural%20daylight%20through%20large%20windows%20colorful%20collaborative%20student%20desks%20grouped%20for%20teamwork%20organized%20clean%20contemporary%20school%20interior%20warm%20inviting%20educational%20atmosphere%20professional%20photography&width=900&height=640&seq=fac-main-2&orientation=landscape"
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-5 gap-6 transition-all duration-700 delay-400 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <div className="lg:col-span-2 rounded-2xl overflow-hidden h-[140px] lg:h-auto facility-img-wrap">
            <img
              src="https://readdy.ai/api/search-image?query=bright%20colorful%20children%20playground%20with%20safe%20modern%20equipment%20in%20a%20private%20school%20outdoor%20area%20green%20grass%20sunny%20day%20clean%20fenced%20yard%20professional%20photography%20educational%20institution%20exterior%20warm%20natural%20tones%20no%20children%20visible&width=560&height=280&seq=fac-play-3&orientation=landscape"
